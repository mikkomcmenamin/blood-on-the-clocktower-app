...
export declare type Serialize<T> = IsAny<T> extends true ? any : T extends JsonPrimitive ? T : T extends Map<any, any> | Set<any> ? {} : T extends NonJsonPrimitive ? never : T extends {
    toJSON(): infer U;
